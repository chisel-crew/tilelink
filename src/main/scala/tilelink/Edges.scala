  ...
  def staticHasData(bundle: TLChannel): Option[Boolean] =
    bundle match {
      case _: TLBundleA => {
        ...
        val aDataYes =
          manager.anySupportArithmetic || manager.anySupportLogical || manager.anySupportPutFull || manager.anySupportPutPartial
      ...
      case _: TLBundleB => {
        ...
        val bDataYes =
          client.anySupportArithmetic || client.anySupportLogical || client.anySupportPutFull || client.anySupportPutPartial
      ...
      case _: TLBundleC => {
        ...
        val cDataYes =
          client.anySupportGet || client.anySupportArithmetic || client.anySupportLogical || client.anySupportProbe
        // Do there exist C messages without Data?
        val cDataNo =
          client.anySupportPutFull || client.anySupportPutPartial || client.anySupportHint || client.anySupportProbe
        if (!cDataYes) Some(false) else if (!cDataNo) Some(true) else None
      }
      case _: TLBundleD => {
        // Do there eixst D messages with Data?
        val dDataYes =
          manager.anySupportGet || manager.anySupportArithmetic || manager.anySupportLogical || manager.anySupportAcquireB
        // Do there exist D messages without Data?
        val dDataNo =
          manager.anySupportPutFull || manager.anySupportPutPartial || manager.anySupportHint || manager.anySupportAcquireT
...
class TLEdgeOut(
  ...
  def AcquireBlock(fromSource: UInt, toAddress: UInt, lgSize: UInt, growPermissions: UInt) = {
    require(
      manager.anySupportAcquireB,
      s"TileLink: No managers visible from this edge support Acquires, but one of these clients would try to request one: ${client.clients}"
    )
  ...
  def Get(fromSource: UInt, toAddress: UInt, lgSize: UInt) = {
    require(
      manager.anySupportGet,
      s"TileLink: No managers visible from this edge support Gets, but one of these clients would try to request one: ${client.clients}"
    )
  ...
  def Put(fromSource: UInt, toAddress: UInt, lgSize: UInt, data: UInt, corrupt: Bool): (Bool, TLBundleA) = {
    require(
      manager.anySupportPutFull,
      s"TileLink: No managers visible from this edge support Puts, but one of these clients would try to request one: ${client.clients}"
    )
  ...
  def Put(fromSource: UInt, toAddress: UInt, lgSize: UInt, data: UInt, mask: UInt, corrupt: Bool): (Bool, TLBundleA) = {
    require(
      manager.anySupportPutPartial,
      s"TileLink: No managers visible from this edge support masked Puts, but one of these clients would try to request one: ${client.clients}"
    )
  ...
  def Arithmetic(
    ...
    data: UInt,
    atomic: UInt,
    corrupt: Bool = Bool(false)
  ): (Bool, TLBundleA) = {
    require(
      manager.anySupportArithmetic,
      s"TileLink: No managers visible from this edge support arithmetic AMOs, but one of these clients would try to request one: ${client.clients}"
    )
  ...
  def Logical(
    ...
    require(
      manager.anySupportLogical,
      s"TileLink: No managers visible from this edge support logical AMOs, but one of these clients would try to request one: ${client.clients}"
    )
  ...
  def Hint(fromSource: UInt, toAddress: UInt, lgSize: UInt, param: UInt) = {
    require(
      manager.anySupportHint,
      s"TileLink: No managers visible from this edge support Hints, but one of these clients would try to request one: ${client.clients}"
    )
  ...
  def AccessAck(b: TLBundleB, data: UInt, corrupt: Bool): TLBundleC =
    AccessAck(b.source, address(b), b.size, data, corrupt)
  def AccessAck(fromSource: UInt, toAddress: UInt, lgSize: UInt, data: UInt): TLBundleC =
    AccessAck(fromSource, toAddress, lgSize, data, Bool(false))
...
class TLEdgeIn(
  ...
  def Probe(fromAddress: UInt, toSource: UInt, lgSize: UInt, capPermissions: UInt) = {
    require(
      client.anySupportProbe,
      s"TileLink: No clients visible from this edge support probes, but one of these managers tried to issue one: ${manager.managers}"
    )
  ...
  def Grant(fromSink: UInt, toSource: UInt, lgSize: UInt, capPermissions: UInt): TLBundleD =
    Grant(fromSink, toSource, lgSize, capPermissions, Bool(false))
  ...
  def Grant(fromSink: UInt, toSource: UInt, lgSize: UInt, capPermissions: UInt, data: UInt): TLBundleD =
    Grant(fromSink, toSource, lgSize, capPermissions, data, Bool(false), Bool(false))
  def Grant(
    fromSink: UInt,
    toSource: UInt,
    lgSize: UInt,
  ...
  def Get(fromAddress: UInt, toSource: UInt, lgSize: UInt) = {
    require(
      client.anySupportGet,
      s"TileLink: No clients visible from this edge support Gets, but one of these managers would try to issue one: ${manager.managers}"
    )
  ...
  def Put(fromAddress: UInt, toSource: UInt, lgSize: UInt, data: UInt, corrupt: Bool): (Bool, TLBundleB) = {
    require(
      client.anySupportPutFull,
      s"TileLink: No clients visible from this edge support Puts, but one of these managers would try to issue one: ${manager.managers}"
    )
  ...
  def Put(fromAddress: UInt, toSource: UInt, lgSize: UInt, data: UInt, mask: UInt, corrupt: Bool): (Bool, TLBundleB) = {
    require(
      client.anySupportPutPartial,
      s"TileLink: No clients visible from this edge support masked Puts, but one of these managers would try to request one: ${manager.managers}"
    )
  ...
  def Arithmetic(
    ...
    require(
      client.anySupportArithmetic,
      s"TileLink: No clients visible from this edge support arithmetic AMOs, but one of these managers would try to request one: ${manager.managers}"
    )
  ...
  def Logical(
    ...
    require(
      client.anySupportLogical,
      s"TileLink: No clients visible from this edge support logical AMOs, but one of these managers would try to request one: ${manager.managers}"
    )
  ...
  def Hint(fromAddress: UInt, toSource: UInt, lgSize: UInt, param: UInt) = {
    require(
      client.anySupportHint,
      s"TileLink: No clients visible from this edge support Hints, but one of these managers would try to request one: ${manager.managers}"
    )
  ...
  def AccessAck(a: TLBundleA, data: UInt, denied: Bool, corrupt: Bool): TLBundleD =
    AccessAck(a.source, a.size, data, denied, corrupt)
  def AccessAck(toSource: UInt, lgSize: UInt, data: UInt): TLBundleD =
    AccessAck(toSource, lgSize, data, Bool(false), Bool(false))
